// This code was generated and developed in STM32CubeIDE
#include "main.h"
...
// Toggle switch "1" and "4" to allow forward motor rotation
void HBridge_Forward(void){
	HAL_GPIO_TogglePin(GPIOC, GPIO_PIN_8); // SW1
	HAL_GPIO_TogglePin(GPIOC, GPIO_PIN_5); // SW4
}

// Toggle switch "2" and "3" to allow backward motor rotation
void HBridge_Backward(void){
